...
@section('content')
    <br>
    <p><a href="{{ url('/listOffre') }}" style="width: 150px;">&lt; Retour</a></p>
    <br>
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Résulat de votre recherche...</h4>
                </p>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            @if ($offre)
                                <tr>
                                    <td>{{ $offre->id }}</td>
                                    <td><img src="{{ asset('storage/photo_offres/' . $offre->image) }}" alt="Image_Produit"
                                            style="width: 90%; border-radius: 25%;"></td>
